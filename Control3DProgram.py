...
class GraphicsProgram3D:
    def __init__(self):
        ...
        self.texture_amethyst_diffuse = load_texture("/BallSaul2.jpeg")
        self.texture_amethyst_specular = load_texture("/SkyDomSaul.jpeg")
        self.texture_galaxy = load_texture("/SkyDomSaul.jpeg")
    ...
    def update(self):
        ...
        if self.LEFT_key_down:
            self.platform.slide(-10 * delta_time, self.frame.w)
